export const jobs = [
    {
        ...
        skills: {
            nonNegotiable: ["Python", "Backend Development", "REST APIs", "Databases"],
            negotiable: ["AI/ML Concepts", "Microservices", "Cloud Platforms"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["SAP", "Change Management", "Release Management", "SAP Environment Management"],
            negotiable: ["S/4HANA Cloud", "Regression Testing", "Transport Management"]
        },
        requirements: [
    ...
    // },
    {
        ...
        skills: {
            nonNegotiable: ["Power Automate", "Microsoft 365 Integration", "Workflow Automation"],
            negotiable: ["Power Platform", "RPA", "Mentoring"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Power Apps", "Troubleshooting", "Support"],
            negotiable: ["Power Platform", "On-Call Support"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Power Apps", "Application Development", "Performance Optimization"],
            negotiable: ["Power Platform", "Deployment Management"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["End-User Support", "Troubleshooting", "Azure"],
            negotiable: ["Network/Security Basics", "Service Desk Escalation", "Mentoring"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Business Transformation", "Process Improvement", "Operating Models"],
            negotiable: ["Roadmaps", "Change Adoption", "Cross-Regional Leadership"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Transformation Delivery", "Program Execution", "Process Improvement"],
            negotiable: ["Coaching/Mentoring", "Stakeholder Management"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Technical Recruiting", "IT Hiring", "Talent Acquisition"],
            negotiable: ["Leadership/People Management", "Automation/Digital Hiring"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["HR Leadership", "Talent Acquisition", "HR Operations"],
            negotiable: ["Global HR", "India Recruiting", "Scaling Organizations"]
        },
        requirements: [
    ...
    // },
    {
        ...
        skills: {
            nonNegotiable: ["General Ledger", "Accounting", "Advanced Excel"],
            negotiable: ["Financial Reporting", "UK Finance Standards"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Accounts Payable", "Accounts Receivable", "Financial Controls"],
            negotiable: ["Cash Flow Optimization", "Process Improvement", "Team Leadership"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Data Migration", "Data Integrity", "Data Validation"],
            negotiable: ["Stakeholder Management", "Data Architecture", "Risk Management"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["CRM Support", "ERP Support", "Troubleshooting"],
            negotiable: ["Workflow Analysis", "User Enablement", "System Configuration"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Internal Communications", "Content Writing", "PowerPoint"],
            negotiable: ["SharePoint", "Video Creation", "Visual Storytelling"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["AI/ML", "Python", "LLMs"],
            negotiable: ["GenAI", "Cloud AI Platforms", "MLOps"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Accounts Receivable", "Cash Application", "Reconciliation"],
            negotiable: ["ERP Systems", "GAAP/SOX Compliance"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Network Administration", "Azure Networking", "Palo Alto Firewalls"],
            negotiable: ["VPN", "Zero Trust", "Prisma Access"]
        },
        requirements: [
    ...
    },
    {
        ...
        skills: {
            nonNegotiable: ["Excel", "SQL", "Data Analysis"],
            negotiable: ["Power BI/Tableau", "Data Automation", "MS Access"]
        },
        requirements: [
